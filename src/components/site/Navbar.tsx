      ...
      >
        ...
        <div className="flex items-center" style={{ gap: "28px" }}>
          ...
          {[
            ...
            { label: "Endorsements", to: "/policy-services" },
          ].map((l) => (
            <Link
              key={l.to}
              to={l.to}
            ...
            >
              <div className="flex flex-1 flex-col justify-between" style={{ fontFamily: "'Barlow', sans-serif" }}>
                <Link
                  to="/"
                  onClick={() => setOpen(false)}
                  className="border-b border-white/5 py-2.5 text-[22px] font-semibold tracking-tight text-white hover:text-white/75"
                >
                  Home
                </Link>
                <div className="border-b border-white/5">
                  <button
                    ...
                    className="flex w-full items-center justify-between py-2.5 text-[22px] font-semibold tracking-tight text-white hover:text-white/75"
                  >
                    Solutions
                    <ChevronDown
