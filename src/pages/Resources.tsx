        ...
        <div className="mx-auto w-full max-w-[1200px]">
          ...
          <div className="grid gap-6 grid-cols-1 min-[480px]:grid-cols-2 md:grid-cols-3">
            {[
              ...
              >
                <h3 className="text-[18px] font-bold text-white" style={barlow}>
                  {c.title}
                </h3>
        ...
        <div className="mt-10 grid gap-6 sm:grid-cols-2 md:grid-cols-3">
          {guides.map((g) => (
            ...
            >
              ...
              <p className="mt-3 text-[14px] leading-[1.7] text-white/65">{g.text}</p>
            ...
            {faqs.map((f, i) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <span className="text-[16px] font-semibold text-white" style={barlow}>
                      {f.q}
                    </span>
                  ...
                  {isOpen && (
                    <div className="border-t border-white/10 px-5 py-4 text-[14px] leading-[1.7] text-white/70">
                      {f.a}
                    </div>
                  )}
                </div>
        ...
        <div className="mx-auto max-w-[900px]">
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-2">
            {glossary.map(([term, def]) => (
              ...
              >
                <h4 className="text-[15px] font-bold text-white" style={barlow}>
                  {term}
                </h4>

                <p className="mt-2 text-[13px] leading-[1.6] text-white/65">{def}</p>
              </div>
            ))}
          </div>
        </div>
