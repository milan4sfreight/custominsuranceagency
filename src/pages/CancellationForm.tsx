...
const CancellationForm = () => (
  <main className="min-h-screen bg-white font-['Inter',sans-serif]">
    <SEO title="Cancellation Request | Custom Insurance Agency" description="Submit a policy cancellation request online." />
    <Navbar />
    <section className="px-6 pt-32 pb-20 md:px-12">
      <div className="mx-auto max-w-[800px] text-center">
        ...
        <p className="mt-4 text-[15px] leading-[1.7] text-[#4a5568]">
          The online cancellation form is coming soon. In the meantime, please contact us to submit your request.
        </p>
