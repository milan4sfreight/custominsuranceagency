    ...
    <div className="min-h-screen bg-background" style={{ fontFamily: "'Barlow', sans-serif" }}>
      ...
      <section className="bg-white">
        <div className="mx-auto w-full max-w-[900px] px-6 pb-[80px]" style={{ paddingTop: 40 }}>
          <h2 style={{ ...barlow, fontSize: 36, fontWeight: 700, lineHeight: 1.2, color: "#0d2b2b" }}>
            We're Here to Help.
          </h2>

          <p className="mt-5 text-[16px] leading-[1.75] text-[#374151]" style={{ fontFamily: "'Inter', sans-serif" }}>
